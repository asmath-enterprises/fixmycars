...
var Autocare = (function () {
  ...
  //   var support =
  //     '<a href="#" target="_blank" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>Support</span></a><!-- Go to www.addthis.com/dashboard to customize your tools --><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script>';
...
/*  Window Resize END */
$("#social li")
  .not($("#social li social-menu li a"))
  .click(function () {
    $("ul.social-menu").not($(this).children()).slideUp();
    $(this).children("ul.social-menu").slideToggle();
  });
